...
public class Main {
    public static void main(String[] args) {
        ...
        Persona[] persone = new Persona[6]; // 6 elementi per includere tutti
        ...
        for (Persona persona : persone) {
            ...
            if (persona instanceof Dipendente) {
                ...
                Dirigente dir = (Dirigente) persona;
                System.out.println("Matricola: " + dir.getMatricola() + " | Ruolo: " + dir.getRuolo() + " | Salario: " + dir.calculateSalary());
            }
        }
    }
}
